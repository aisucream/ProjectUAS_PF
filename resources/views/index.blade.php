...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
       ...
       <a href="{{ url('/') }}" class="logo"><img src="assets/img/download 1.png" alt="" class="img-fluid"></a>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
            ...
            <a href="{{url ('/About') }}" class="read-more">Predict <i class="bi bi-long-arrow-right"></i></a>
        </div>
